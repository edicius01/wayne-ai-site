        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#475569] text-lg mb-12 max-w-xl mx-auto">
              We'd rather not hand you a rebooking projection for a client list we've never
              seen. Instead, test the system before you talk to us. Call{' '}
        ...
        <section id="lp-form" className="bg-[#0f172a] py-20 px-6">
          <div className="max-w-xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-2xl sm:p-8">
              <LeadCallbackForm slug="wayneai-lp-medspa" />
            </div>
